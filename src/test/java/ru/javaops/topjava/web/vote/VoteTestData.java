...
public class VoteTestData {
    ...
    public static final Vote vote2 = new Vote(VOTE1_ID + 1, RESTAURANT1,of(2020, Month.JANUARY, 30, 13, 0) );
    public static final Vote vote3 = new Vote(VOTE1_ID + 2, RESTAURANT1,of(2020, Month.JANUARY, 30, 20, 0));
    public static final Vote vote4 = new Vote(VOTE1_ID + 3, RESTAURANT1,of(2020, Month.JANUARY, 31, 0, 0));
    public static final Vote vote5 = new Vote(VOTE1_ID + 4, RESTAURANT1, of(2020, Month.JANUARY, 31, 10, 0));
    public static final Vote vote6 = new Vote(VOTE1_ID + 5, RESTAURANT1, of(2020, Month.JANUARY, 31, 13, 0));
    public static final Vote vote7 = new Vote(VOTE1_ID + 6, RESTAURANT1,of(2020, Month.JANUARY, 31, 20, 0));
    public static final Vote adminVote1 = new Vote(ADMIN_VOTE_ID, RESTAURANT1,of(2020, Month.JANUARY, 31, 14, 0));
    public static final Vote adminVote2 = new Vote(ADMIN_VOTE_ID + 1, RESTAURANT1, of(2020, Month.JANUARY, 31, 21, 0));
